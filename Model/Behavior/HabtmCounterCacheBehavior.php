 ...
 * @param Model $model
 */
	protected function _setOldHabtmIds(Model $model) {
 ...
 * @param Model $model
 */
	protected function _setNewHabtmIds(Model $model) {
 ...
 * @param Model $model
 */
	protected function _updateCounterCache(Model $model) {
 ...
 * @return array
 */
	public function getMenuWithUnderCounts(Model $model, $habtmAlias, $options = array()) {
 ...
 * @return array
 */
	protected function _formatMenuWithUnderCounts(Model $model, $habtmAlias, $items, $options) {
		$settings = $this->settings[$model->alias][$habtmAlias];
